...
#define VY_LED_3(status) writePin(B3, (bool)status)

#define VY_LED_4(status) mcp23018_leds[0] = (bool)status
#define VY_LED_5(status) mcp23018_leds[1] = (bool)status
#define VY_LED_6(status) mcp23018_leds[2] = (bool)status
